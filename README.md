...
[![PhysioNet](https://img.shields.io/badge/data-PhysioNet-orange)](https://physionet.org/)
...
![Degradation curves by noise type](outputs/figures/degradation_curves.png)
...
One beat: clean (left) then the same beat with increasing noise at 24 → −6 dB for each noise type (BW, MA, EM). Generated by `src/noise_mixer.py`.

![Noise examples: one beat at 6 SNR levels per noise type](outputs/figures/noise_examples.png)

### Heatmap and accuracy drop

Macro F1 across models and SNR levels (all three noise types), and accuracy at key SNR levels.

![Robustness heatmap](outputs/figures/robustness_heatmap.png)

![Accuracy at key SNR levels](outputs/figures/accuracy_drop.png)
